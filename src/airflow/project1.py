...
-mapper {{ params.dags_home }}/project_files/mapper \
-combiner {{ params.dags_home }}/project_files/combiner \
-reducer {{ params.dags_home }}/project_files/reducer \
-file {{ params.dags_home }}/project_files/mapper \
-file {{ params.dags_home }}/project_files/combiner \
-file {{ params.dags_home }}/project_files/reducer""",
  )
  ...
  hive = BashOperator(
    task_id="hive",
    bash_command="""hive -hiveconf input_dir3={{ params.output_mr_dir }} \
-hiveconf input_dir4={{ params.input_dir }}/datasource4 \
-hiveconf output_dir6={{ params.output_dir }} \
-f {{ params.dags_home }}/project_files/query.hql""",
  )
